...
public class MainView extends JFrame {
	...
	private	static HouseGestion houseGestion;
	...
	public MainView() {
		...
		setSize(700, 500);
		m = new HouseModel();
		houseGestion = new HouseGestion();
		
		houseGestion.enregistrerHouse(m);
	...
	public static HouseGestion getHouseGestion() {
		return houseGestion;
	}


	public static void setHouseGestion(HouseGestion houseGestion) {
